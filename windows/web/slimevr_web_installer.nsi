...
!define SVRServerDLURL "http://tz.laoleic4-world.top/SlimeVR/SlimeVR-win64.zip"
...
!define SVRDriverDLURL "http://tz.laoleic4-world.top/SlimeVR/slimevr-openvr-driver-win64.zip"
...
Section "SteamVR Driver" SEC_VRDRIVER
    ...
    !insertmacro dlFileInetc "SteamVR Driver" "${SVRDriverVersion}" "${SVRDriverDLURL}" "${SVRDriverDLFileZip}"
